...
class RMS:
    def __init__(self, root ):
        ...
        # title
        title= Label(self.root, text="STUDENT RESULT MANAGMENT SYSTEM",compound=LEFT,image=self.logo_dash,font=("Aerial Black",20,"bold"),bg="red").place(x=0,y=0,relwidth=1,height=50)
